...
public class ManageProductCatalogJPanel extends javax.swing.JPanel {
    ...
    public ManageProductCatalogJPanel(JPanel upc, UserAccount ua) {
        initComponents();
    ...
    private void refreshTable() {
        ...
        for(Product p : userAccount.getProductCatalog().getProductCatalog()) {
            ...
            row[4] = p.isHazardous();
            row[5] = p.getManufacturer();
            row[6] = p.getDistributor();
            row[7] = p.getExpirationDate();
            model.addRow(row);
            }
        }
    ...
    private void initComponents() {
        ...
        productCatalog.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Product Name", "Product ID", "Price", "Availability", "Hazardous", "Manufacturer", "Distributor", "Expiration Date"
            }
        ) {
        ...
        add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 150, 680, 170));
    ...
    private void createPButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createPButtonActionPerformed
        CreateNewProductJPanel cnpjp = new CreateNewProductJPanel(userProcessContainer, userAccount);
    ...
    private void searchPButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchPButtonActionPerformed
        // TODO add your handling code here:
        SearchForProductJPanel sfpjp = new SearchForProductJPanel(userProcessContainer, userAccount);
    ...
    private void delButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_delButton5ActionPerformed
        ...
        Product p = (Product)productCatalog.getValueAt(row, 0);
        userAccount.getProductCatalog().removeProduct(p);
        refreshTable();
